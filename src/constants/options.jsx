export const SelectTravelesList = [
  ...
  Provide a list of hotel options of atleast 3 hotels including the name, address, and the most recent image URL (ensure the URL is working), geo coordinates, rating, and descriptions. 
